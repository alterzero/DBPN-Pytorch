...
class Net(nn.Module):
    def __init__(self, num_channels, base_filter, feat, num_stages, scale_factor):
        ...
        self.up11 = D_UpBlock(base_filter, kernel, stride, padding, 10)
        self.down11 = D_DownBlock(base_filter, kernel, stride, padding, 11)
        self.up12 = D_UpBlock(base_filter, kernel, stride, padding, 11)
        #Reconstruction
